...
public class TopicController {
    ...
    @Transactional
    @Operation(
            summary = "Next,Register a new topic",
            tags = {"topic", "post"}
    )
    ...
    @GetMapping
    @Operation(
            summary = "Please, show all active topics",
            tags = {"topic", "get"}
    )
    ...
    @GetMapping("/{id}")
    @Operation(
            summary = "Please show the association of responses and the subject or topic",
            tags = {"topic", "get"}
    )
    ...
    @Transactional
    @Operation(
            summary = "Below, it is suggested to update the information on the topics",
            tags = {"topic", "put"}
    )
    ...
    @Transactional
    @Operation(
            summary = "delete the topic, please",
            tags = {"topic", "delete"}
    )
